import { Bi as BoundStoreAction, Nt as OrganizationBase, ci as Application, fi as ApplicationInclude, zi as StateSource } from "./authStore-BO2vch3I.js";
 ...
 * @public
 */
interface MessageBusMessage<T, R = never> {
...
interface MessageBus {
  ...
  emit<K extends EventTopic>(type: K, ...rest: PayloadOf<K> extends void ? [payload?: void, options?: MessageBusEmitOptions] : [payload: PayloadOf<K>, options?: MessageBusEmitOptions]): MessageBusEmitResult<ReplyOf<K>>;
  ...
  subscribe<K extends EventTopic>(type: K, handler: (message: MessageBusMessage<PayloadOf<K>, ReplyOf<K>>) => void, options?: MessageBusAbortOptions): void;
  /** Runs a handler for each state value until its signal aborts. */
  subscribe<K extends StateTopic>(type: K, handler: (value: ValueOf<K>) => void, options?: MessageBusAbortOptions): void;
 ...
 * @public
 */
interface MessageBusConnection extends MessageBus {
  /**
 ...
 * @public
 */
interface MessageBusHost extends MessageBusConnection {
  /**
 ...
 * @internal
 */
declare function installMessageBus(options?: InstallMessageBusOptions): MessageBusHost;
/**
...
export { PayloadOf as A, ApplicationConfig as C, EventTopicDef as D, EventTopic as E, TopicName as F, TopicResult as I, Topics as L, ReplyOf as M, StateTopic as N, NavigationLocation as O, StateTopicDef as P, ValueOf as R, resetMessageBus as S, DashboardTopics as T, MessageBusMeta as _, ConnectMessageBusOptions as a, connectMessageBus as b, MessageBusAbortOptions as c, MessageBusEmitOptions as d, MessageBusEmitResult as f, MessageBusMessage as g, MessageBusHost as h, resolveTopic as i, RemoteModuleRef as j, NavigationTarget as k, MessageBusClient as l, MessageBusErrorCode as m, TopicError as n, InstallMessageBusOptions as o, MessageBusError as p, getTopicState as r, MessageBus as s, TopicData as t, MessageBusConnection as u, MessageBusQueryOptions as v, ApplicationConfigAppType as w, installMessageBus as x, MessageBusStateSource as y };
//# sourceMappingURL=topicStore-D0WqhQGF.d.ts.map