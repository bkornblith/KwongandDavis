...
import { Ai as CacheWriter, Bi as BoundStoreAction, Er as parseCommentsOptionsKey, Fi as MutationResult, Ii as defineFetcher, Li as defineMutation, Mi as FetcherDefinition, Ni as FetcherSnapshot, Pi as MutationDefinition, V as parseQueryKey, bt as GetUsersOptions, gr as createLogger, ji as Fetcher, ki as CacheTag, nt as PreviewValue, tt as PreviewQueryResult, wr as getCommentsOptionsKey, z as getQueryKey } from "../authStore-BO2vch3I.js";
import { S as resetMessageBus, i as resolveTopic, o as InstallMessageBusOptions, r as getTopicState, u as MessageBusConnection, x as installMessageBus } from "../topicStore-D0WqhQGF.js";
 ...
 * @internal
 */
export declare const getDashboardMessageBus: BoundStoreAction<DashboardMessageBusState, [moduleId?: string | undefined], MessageBusConnection | undefined>;
/**
...
export { type ApiErrorBody, type CacheTag, type CacheWriter, type Fetcher, type FetcherDefinition, type FetcherSnapshot, type InstallMessageBusOptions, type MutationDefinition, type MutationResult, createLogger, defineFetcher, defineMutation, getCommentsOptionsKey, getQueryKey, getTopicState, installMessageBus, parseCommentsOptionsKey, parseQueryKey, resetMessageBus, resolveTopic };
