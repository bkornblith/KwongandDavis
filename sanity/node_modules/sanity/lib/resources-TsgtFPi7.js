import { f as defineLocalesResources } from "./PerspectiveProvider-D-6sweQH.js";
/**
...
const releasesLocaleStrings = defineLocalesResources("releases", {
	...
	* leading arrow already conveys "back", so the label names the destination only. */
	...
	"revert-dialog.confirm-revert.summary-restore_one": "{{count}} document will be restored to its last published revision from before this release.",
	/** Revert dialog summary line for documents that will be restored to a previous revision */
	"revert-dialog.confirm-revert.summary-restore_other": "{{count}} documents will be restored to their last published revision from before this release.",
	...
	"revert-dialog.confirm-revert.summary-unpublish_one": "{{count}} document will be unpublished because it was not published before this release.",
	/** Revert dialog summary line for documents that will be unpublished because they were not published right before the release */
	"revert-dialog.confirm-revert.summary-unpublish_other": "{{count}} documents will be unpublished because they were not published before this release.",
	/** Error card in the revert dialog when the history needed to revert some documents is no longer available */
	"revert-dialog.confirm-revert.history-unavailable-card_one": "The previous state of {{count}} document is no longer available in the document history, so the release cannot be reverted.",
	/** Error card in the revert dialog when the history needed to revert some documents is no longer available */
	"revert-dialog.confirm-revert.history-unavailable-card_other": "The previous state of {{count}} documents is no longer available in the document history, so the release cannot be reverted.",
	/** Error card in the revert dialog when the previous state of some documents could not be determined */
	"revert-dialog.confirm-revert.unresolved-card_one": "The previous state of {{count}} document could not be determined, so the release cannot be reverted.",
	/** Error card in the revert dialog when the previous state of some documents could not be determined */
	"revert-dialog.confirm-revert.unresolved-card_other": "The previous state of {{count}} documents could not be determined, so the release cannot be reverted.",
...
//# sourceMappingURL=resources-TsgtFPi7.js.map